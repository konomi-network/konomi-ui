...
import { getIsFetchingOceans, getUserOceansByNetwork } from 'modules/oceans/reducer';
...
const OceanLend: React.FC<TProps> = ({ oceans }) => {
...
const mapStateToProps = (state: RootState) => ({
  oceans: getUserOceansByNetwork(state)
});

export default connect(mapStateToProps)(OceanLend);
